...
public class EllipticCurve {
    ...
    public static void main(String[] args) {
        ...
        ECPoint p1 = new ECPoint(3, 5);
        ECPoint q1= new ECPoint(5, 9);
        
        
        // This computes (2, 4) + (5, 9) in y^2 = x^3 + x + 6 mod 11
        
        ECPoint p = EllipticCurve.NIST_P_521.getBasePoint();
      
        ECPoint q = new ECPoint(new BigInteger("433c219024277e7e682fcb288148c282747403279b1ccc06352c6e5505d769be97b3b204da6ef55507aa104a3a35c5af41cf2fa364d60fd967f43e3933ba6d783d",16), new BigInteger("f4bb8cc7f86db26700a7f3eceeeed3f0b5c6b5107c4da97740ab21a29906c42dbbb3e377de9f251f6b93937fa99a3248f4eafcbe95edc0f4f71be356d661f41b02",16));
        
        System.out.println(p + " + " + q + " = " + EllipticCurve.NIST_P_521.add(p, q));
      /*  for (int i = 0; i < 20; ++i) {
